...
def fim_do_jogo():
    ...
    if jogador_voce>jogador_pc:
        app_vencedor = Label(frame_baixo, text="Parabéns!!", height=1, anchor='center', font=('Ivy 10 bold'), bg=co0, fg= co4)
        app_vencedor.place(x=5, y=60)


    elif jogador_voce<jogador_pc:
        app_vencedor = Label(frame_baixo, text="Ops! vc perdeu!", height=1, anchor='center', font=('Ivy 10 bold'), bg=co0, fg= co5)
        app_vencedor.place(x=5, y=60)
    
    else:
        app_vencedor = Label(frame_baixo, text="Ops! Empate!", height=1, anchor='center', font=('Ivy 10 bold'), bg=co0, fg= co1)
        app_vencedor.place(x=5, y=60)
    ...
    b_jogar_denovo = Button(frame_baixo,command=jogar_denovo, width=30, text='Jogar novamente' , bg=fundo, fg=co0, font=('Ivy 10 bold'), anchor= CENTER, relief=RAISED, overrelief=RIDGE)
